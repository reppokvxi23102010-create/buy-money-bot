...
// ==================== 1. WEB SERVER DÀNH CHO RENDER (24/7) ====================
const PORT = process.env.PORT || 10000;
http.createServer((req, res) => {
    res.writeHead(200, { 'Content-Type': 'text/plain; charset=utf-8' });
    res.end('Bot AutoBuy KingSMP 24/7 đang hoạt động mượt mà!');
}).listen(PORT, () => {
...
// Bắt ngoại lệ chống sập Bot khi chạy trên Server
...
if (botToken) {
    ...
    console.error('❌ Lỗi: Không tìm thấy DISCORD_TOKEN trong Environment Variables!');
}
